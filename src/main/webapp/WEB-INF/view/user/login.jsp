...
<body>
	...
	<table>
		<tr>
			<td id="tab1" class="tab"><a href="javascript:disp_div('minfo','tab1')">일반 회원</a></td>
			<td id="tab2" class="tab"><a href="javascript:disp_div('oinfo','tab2')">기업 회원</a></td>
		</tr>
	</table>
	...
	<%-- <form:form modelAttribute="company" method="post" action="Companylogin.shop">
		<input type="hidden" name="userName" value="유효성 검증을 위한 의미없는 이름" />
		<spring:hasBindErrors name="user">
			<font color="red"> 
		...
		<table id="oinfo" class="info" border="1" style="border-collapse: collapse;">
			<tr height="40px">
				<td>기업 아이디</td>
				<td><form:input path="comid" /> <font color="red"><form:errors path="comid" /></font></td>
			</tr>
			<tr height="40px">
				<td>비밀번호</td>
				<td><form:password path="compass" /> <font color="red"><form:errors path="compass" /></font></td>
			</tr>
			<tr height="40px">
				<td colspan="2" align="center"><input type="submit" value="로그인">
					<input type="button" value="회원가입" onclick="location.href='../user/userEntry.shop'"></td>
			</tr>
		</table>
	</form:form> --%>
</body>
