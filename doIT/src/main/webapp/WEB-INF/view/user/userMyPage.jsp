		    ...
		    <div class="w3-col m2 w3-hide-small" style="min-width: 220px; float: right;">
		      ...
		      <div class="w3-card w3-round w3-white" style="margin-top:25px;">
		        ...
		        <div class="w3-center">
		           ...
		           <a href="#" onclick="pass_chg();">비밀번호 변경</a><br><br>
    ...
    <div class="col-sm-6">
		...
		<div style="width: 100%; min-height: 300px; padding: 5px 0 5px 0; margin-bottom: 50px;" class="w3-card"> <!-- 이력서 현황 -->	
			...
			<div style="font-size: 15px; background-color: #EBF7FF; width: 900px; margin: auto;">
				<div style="font-family: 'Nanum Gothic Coding', monospace; display: inline-block; width: 650px; text-align: center; border-right: 1px #d6d6d6 solid;">제목</div>
				<div style="font-family: 'Nanum Gothic Coding', monospace; display: inline-block; width: 145px; text-align: center; border-right: 1px #d6d6d6 solid;">작성일</div>
		...
		<div style="width: 100%; min-height: 300px; padding: 5px 0 5px 0; margin-bottom: 50px;" class="w3-card">
			...
			<div style="width: 900px; height:40px; margin: auto auto 30px auto;">
			  <a href="${path }/user/myResume.shop?userno=${sessionScope.loginUser.userno }" class="btn btn-primary" style=" color: black; background-color:#EBF7FF; text-decoration: none; border-radius: 50px; float: right;">작성하기</a>
			</div>
		</div>
